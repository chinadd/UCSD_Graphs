...
public abstract class Graph {
	...
	public static void main (String[] args) {
		...
		System.out.println(airportGraph.degreeSequence());
		System.out.println("****");
		...
		System.out.println("****");
		System.out.println("Roads / intersections:");
		GraphAdjList graphNYC = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/bigapple.map", graphNYC);
		System.out.println(graphNYC);
